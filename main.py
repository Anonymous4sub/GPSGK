...
flags.DEFINE_integer("feature_dim", 64, "dimension of transformed feature") # cora: 64, citeseer:64
...
flags.DEFINE_integer("pretrain_step", 100, " ") # cora: 100; citeseer:100
flags.DEFINE_float("dropout", 0.5, "")  # 0.5 
flags.DEFINE_float("weight_decay", 5e-4, "") # cora: 5e-4; citeseer:5e-4
flags.DEFINE_float("lr", 0.0005, "learning rate") # cora: 0.0005; citeseer:0.0005
